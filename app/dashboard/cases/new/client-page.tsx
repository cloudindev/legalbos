...
export default function NewCaseClientPage({
    initialClients,
    initialTypes,
    initialDirectoryContacts,
    initialFirmUsers
}: {
    initialClients: any[],
    initialTypes: any[],
    initialDirectoryContacts: any[],
    initialFirmUsers: any[]
}) {
    ...
    const [directoryContacts, setDirectoryContacts] = useState<any[]>(initialDirectoryContacts)
    const [firmUsers, setFirmUsers] = useState<any[]>(initialFirmUsers)
